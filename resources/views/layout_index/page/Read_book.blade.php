            ...
            <div class="tg-404error">
              <div class="col-xs-12 col-sm-12 col-md-8 col-md-push-2 col-lg-6 col-lg-push-3">
                <div class="tg-404errorcontent">
                  <h2>Ooops! {{ __('Can not find') }}</h2>
                  <span>  <figure class="tg-featureimg"><img src=" {{ asset('images/product/' . $product_detail->image) }}" alt="image description"></figure></span>
                </div>
                <form class="tg-formtheme tg-formsearch">
                  <div class="tg-gobackhome">
                    <span><a class="tg-btn" href="{{ route('index') }}"><h4>{{ __('Come back') }}</h4></a></span>
                  </div>
                </form>
              </div>
            </div>
