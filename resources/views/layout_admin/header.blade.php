...
<header class="main-header  ">
    <!-- Logo -->
    <a href="{{ url('index') }}" class="logo"><b><img src="https://cdn.shopify.com/s/files/1/0564/0096/9900/files/bookshop_logo_8d5458ec-1f10-4ee7-9381-4f110eff2e8d.png?v=1621688323" class="user-image" alt="User Image" height="30px" width="100px" style="margin-top: 8px" /></b></a>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu" style="padding-top: 7px;">
                        <!-- User image -->
                        <li style="background-color: #f7ba30" class="user-header">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img style="background-color: #ffffff" src="{{ asset('images/icon/adminicon.png') }}"  class="img-circle" alt="User Image" />
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="{{ url('admin') }}">
                    <i style="color:#f7ba30" class="fa fa-pie-chart fa-lg text-warning"></i>
            ...
            <li class=" treeview">
                <a href="{{ route('companies.index') }}">
                    <i style="color:#f7ba30" class="fa fa-briefcase fa-lg text-warning"></i>
            ...
            <li class=" treeview">
                <a href="{{ route('book.index') }}">
                    <i style="color:#f7ba30" class="fa fa-book fa-lg text-warning"></i>
            ...
            <li class="treeview">
                <a href="{{ route('book_type.index') }}">
                    <i style="color:#f7ba30" class="fa fa-edit  fa-lg text-warning"></i>
            ...
            <li class="treeview">
                <a href="{{ route('bill.index') }}">
                    <i style="color:#f7ba30" class="fa fa-inbox fa-lg text-warning"></i>
            ...
            <li class="treeview">
                <a>
                    <i style="color:#f7ba30" class="fa fa-archive  fa-lg text-warning"></i>
            ...
            <li class="treeview">
                <a href="{{ route('slide.index') }}">
                    <i style="color:#f7ba30" class="fa fa-list-alt  fa-lg text-warning"></i>
                    <span>{{ __('banner') }}</span>
                </a>

            <li class="treeview">
                <a href="{{ route('thenews.index') }}">
                    <i style="color:#f7ba30" class="fa fa-thumbs-o-up  fa-lg text-warning"></i>
                    <span>{{ __('news') }}</span>
                </a>
            @endif
            @endcan
            ...
            <li class="treeview">
                <a href="{{ route('user.index') }}">
                    <i style="color:#f7ba30" class="fa fa-desktop  fa-lg"></i>
            ...
            <li class="treeview">
                <a href="{{ route('member.index') }}">
                    <i style="color:#f7ba30" class="fa fa-user  fa-lg"></i>
            ...
            <li class="treeview">
                <a href="{{ url('logout') }}">
                    <i style="color:#f7ba30" class="fa fa-sign-out  fa-lg text-warning"></i>
