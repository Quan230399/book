                        ...
                        <table id="example" class="table table-striped table-bordered display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                            ...
                                            <div class="cart-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="color-gray your-order-info"><b>Tên sách:</b> {{$bills->name}}</span><br>
                                                        <span class="color-gray your-order-info"><b>Đơn giá:</b> {{number_format($bills->unit_price)}} VNĐ</span><br>
                                                        <span class="color-gray your-order-info"><b>Số lượng:</b> *{{$bills->quantity}} </span>
                                                    </div>
                                                    <br><br>
                                                </div>
                                            </div>
                                    ...
                                    <td>{{number_format($bills->unit_price*$bills->quantity)}} </td>
                                    <td>{{$bills->payment}}</td>
                                    <td>
                                        @php
                                        $disabled = '';
